...
A [web application](https://github.com/Mtrasancos/Iris-Eye/) has also been created for its use.
...
```sh
https://github.com/Mtrasancos/Iris_Eye_Model.git
```
